...
export const Dashboard = () => {
    ...
    const banUser=async(id)=>{
        try {
            const resut=await axios.post('https://weatherbeaconbot-production.up.railway.app/telegram/ban',{userId:id})
    ...
    const unbanUser=async(id)=>{
        try {
            const resut=await axios.post('https://weatherbeaconbot-production.up.railway.app/telegram/unban',{userId:id})
    ...
    const removeUser=async(id)=>{
        try {
            const resut=await axios.post('https://weatherbeaconbot-production.up.railway.app/telegram/remove',{userId:id})
    ...
    const fetchUsers=async()=>{
        try {
            const result=await axios.get('https://weatherbeaconbot-production.up.railway.app/telegram')
